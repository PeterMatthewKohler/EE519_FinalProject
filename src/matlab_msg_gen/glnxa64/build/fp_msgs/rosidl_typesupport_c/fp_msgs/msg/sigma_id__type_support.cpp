...
static const _SigmaID_type_support_symbol_names_t _SigmaID_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fp_msgs, msg, SigmaID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fp_msgs, msg, SigmaID)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fp_msgs, msg, SigmaID)() {
  return &::fp_msgs::msg::rosidl_typesupport_c::SigmaID_message_type_support_handle;
}
