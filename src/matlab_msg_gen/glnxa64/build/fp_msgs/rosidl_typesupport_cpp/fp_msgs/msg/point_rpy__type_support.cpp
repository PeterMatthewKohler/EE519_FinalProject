...
static const _PointRPY_type_support_symbol_names_t _PointRPY_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fp_msgs, msg, PointRPY)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fp_msgs, msg, PointRPY)),
  }
};
...
{
  return &::fp_msgs::msg::rosidl_typesupport_cpp::PointRPY_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fp_msgs, msg, PointRPY)() {
  return get_message_type_support_handle<fp_msgs::msg::PointRPY>();
}
